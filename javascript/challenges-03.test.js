...
Write a function named typeNum that, given an array as input, uses filter to return an array
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter((element) => {
...
from challenge 7. For this function, extend your solution from challenge 7 to only return the name
...
any non-numeric values, then uses map to generate a new array containing the string 'even' or
'odd', depending on the original value.
