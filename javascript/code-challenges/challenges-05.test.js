...
Write a function named addValues that, given an array of numbers as input, uses reduce to add the
values in the array.
...
Write a function named addPurchases that, given an array of objects as input, uses reduce to find
the total amount purchased. Each object contains the keys `item` and `purchasePrice` like the
example.
...
Write a function named reversedString that takes in a string and returns a string with the letters
in reverse order.
...
Write a function named countNumberOfChildren that, given the array of characters, below, uses
reduce to return the total number of children in the data set.
------------------------------------------------------------------------------------------------ */
...
Write a function that, given an array of numbers as input, uses reduce to calculate the array's
average value.
...
Write a function named countPrimeNumbers that, given an array elements as input, uses reduce to
count the number of elements that are prime numbers.
...
Write a function named extractState that, given the snorlaxData, below, uses reduce to return the
object whose 'name' property matches the given string.
