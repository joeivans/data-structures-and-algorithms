...
of each of those numbers raised to the 3rd power (hint: look up Math.pow()). Use forEach to solve
this problem.
...
Write a function named addOne that, given an array of numbers, uses map to return a new array with
...
array and returns a new array. The returned array should contain the result of raising 2 to the
...
from challenge 4 and your forEachTwoToThe function from challenge 5, but uses map instead of a for
loop or forEach.
------------------------------------------------------------------------------------------------ */
...
new array where each element is the result of the `charCodeAt` method on the original array
element.
...
Write a function that, given an array of numbers as input, uses map to return a new array where
each element is either the string "even" or the string "odd", based on each value.

If any element in the array is not a number, the resulting array should have the string "N/A" in
its place.
